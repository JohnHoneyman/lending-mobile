...
import 'package:lendingmobile/core/common/bloc/json_schema_bloc.dart';
import 'package:lendingmobile/core/model/index.dart';

class JsonSchemaForm extends StatefulWidget {
  final Schema schema;
  final JsonSchemaBloc jsonSchemaBloc;

  JsonSchemaForm({required this.schema, required this.jsonSchemaBloc});
...
class _jsonSchemaForm extends State<JsonSchemaForm> {
  ...
  _jsonSchemaForm({required this.schema, required this.jsonSchemaBloc});
